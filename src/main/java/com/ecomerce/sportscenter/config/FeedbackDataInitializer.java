...
public class FeedbackDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        System.out.println("🚀 FeedbackDataInitializer STARTED! (Target: 1200 feedbacks)");
        log.info("Starting Feedback Data Initialization... (Target: 1200 feedbacks)");
        ...
        if (currentFeedbackCount > 0) {
            log.info("Feedbacks already exist! Skipping FeedbackDataInitializer...");
            return;
        }
        ...
        log.info("✅ Successfully created {} feedbacks (target was 1200) for {} users", totalFeedbacks, users.size());
